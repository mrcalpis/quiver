...
- [x] 2. **Skill Scanner (Main Process)**
    - [x] 2.1. Implement frontmatter parser
        ...
        - *Requirements*: US-1
    - [x] 2.2. Implement global skill scanner
        ...
        - *Files*: `src/main/skill-scanner.ts`
        - *Requirements*: US-1
    - [x] 2.3. Implement project skill scanner
    ...
    - [x] 2.4. Register IPC handlers for skills
...
- [x] 3. **Skill Tree UI (Renderer)**
    - [x] 3.1. Build SkillTree sidebar component
        ...
        - *Requirements*: US-1
    - [x] 3.2. Build SearchBar component
        ...
        - *Requirements*: US-1
    - [x] 3.3. Build AppLayout (3-column)
...
- [ ] 4. **File Reading + Skill Detail Panel**
    - [x] 4.1. Implement file read/write IPC handlers
        ...
        - *Files*: `src/main/ipc-handlers.ts`
        - *Requirements*: US-4
    - [x] 4.2. Build SkillInfo component
...
- [x] 5. **Monaco Editor**
    - [x] 5.1. Integrate Monaco Editor
        ...
        - *Requirements*: US-4
    - [x] 5.2. Build MarkdownPreview component
...
- [x] 6. **Version Control (isomorphic-git)**
    - [x] 6.1. Implement git-manager: init + commit
    ...
    - [x] 6.5. Build CommitDialog component
        ...
        - *Requirements*: US-2
    - [x] 6.6. Build VersionHistory + DiffViewer components
...
- [ ] 7. **Quality Analyzer**
    - [x] 7.1. Implement quality-analyzer engine
...
- [x] 8. **Usage Tracking + Dashboard**
    - [x] 8.1. Implement hook scripts
    ...
    - [x] 8.2. Implement hook-installer
        ...
        - *Requirements*: US-1
    - [x] 8.3. Implement usage-tracker (SQLite)
...
- [ ] 9. **New Skill Wizard**
    - [x] 9.1. Implement createSkill IPC handler
        ...
        - *Files*: `src/main/ipc-handlers.ts`
        - *Requirements*: US-5
    - [x] 9.2. Build NewSkillWizard (4-step)
...
- [ ] 10. **Skill Deletion**
    - [x] 10.1. Implement deleteSkill IPC handler
...
- [ ] 11. **Import / Export**
    ...
    - [x] 11.2. Implement importSkill
        ...
        - *Files*: `src/main/ipc-handlers.ts`
        - *Requirements*: NFR-3
    - [x] 11.3. Build ImportDialog + ExportDialog
...
- [ ] 12. **Git Push + Final Polish**
    - [x] 12.1. Commit all work and push to GitHub
